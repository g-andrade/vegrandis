...
-spec atomic_var_new(_Type :: vegrandis_var:var_type()) -> {ok, vegrandis_var:atomic_var()} | {error, out_of_memory}.
atomic_var_new(_Type) ->
    erlang:nif_error(nif_library_not_loaded).

-spec atomic_var_is_lock_free(_Var :: vegrandis_var:atomic_var()) -> boolean().
atomic_var_is_lock_free(_Var) ->
    erlang:nif_error(nif_library_not_loaded).

-spec atomic_var_store(_Var :: vegrandis_var:atomic_var(), _Value :: integer()) -> ok.
atomic_var_store(_Var, _Value) ->
    erlang:nif_error(nif_library_not_loaded).

-spec atomic_var_store(_Var :: vegrandis_var:atomic_var(), _Value :: integer(), _Memory_Order :: vegrandis_var:memory_order()) -> ok.
atomic_var_store(_Var, _Value, _Memory_Order) ->
    erlang:nif_error(nif_library_not_loaded).

-spec atomic_var_load(_Var :: vegrandis_var:atomic_var()) -> integer().
atomic_var_load(_Var) ->
    erlang:nif_error(nif_library_not_loaded).

-spec atomic_var_load(_Var :: vegrandis_var:atomic_var(), _Memory_Order :: vegrandis_var:memory_order()) -> integer().
atomic_var_load(_Var, _Memory_Order) ->
    erlang:nif_error(nif_library_not_loaded).

-spec atomic_var_exchange(_Var :: vegrandis_var:atomic_var(), _Value :: integer()) -> integer().
atomic_var_exchange(_Var, _Value) ->
    erlang:nif_error(nif_library_not_loaded).

-spec atomic_var_exchange(_Var :: vegrandis_var:atomic_var(), _Value :: integer(), _Memory_Order :: vegrandis_var:memory_order()) -> integer().
atomic_var_exchange(_Var, _Value, _Memory_Order) ->
    erlang:nif_error(nif_library_not_loaded).

-spec atomic_var_compare_exchange_weak(_Var :: vegrandis_var:atomic_var(), _Expected :: integer(), _Desired :: integer())
        -> true | {false, integer()}.
atomic_var_compare_exchange_weak(_Var, _Expected, _Desired) ->
    erlang:nif_error(nif_library_not_loaded).

-spec atomic_var_compare_exchange_weak(_Var :: vegrandis_var:atomic_var(), _Expected :: integer(), _Desired :: integer(),
                                       _Succ_Memory_Order :: vegrandis_var:memory_order(), _Fail_Memory_Order :: vegrandis_var:memory_order())
        -> true | {false, integer()}.
atomic_var_compare_exchange_weak(_Var, _Expected, _Desired, _Succ_Memory_Order, _Fail_Memory_Order) ->
    erlang:nif_error(nif_library_not_loaded).

-spec atomic_var_compare_exchange_strong(_Var :: vegrandis_var:atomic_var(), _Expected :: integer(), _Desired :: integer())
        -> true | {false, integer()}.
...
-spec atomic_var_fetch_add(_Var :: vegrandis_var:atomic_var(), _Arg :: integer()) -> integer().
atomic_var_fetch_add(_Var, _Arg) ->
    erlang:nif_error(nif_library_not_loaded).

-spec atomic_var_fetch_add(_Var :: vegrandis_var:atomic_var(), _Arg :: integer(), _Memory_Order :: vegrandis_var:memory_order()) -> integer().
atomic_var_fetch_add(_Var, _Arg, _Memory_Order) ->
    erlang:nif_error(nif_library_not_loaded).

-spec atomic_var_fetch_sub(_Var :: vegrandis_var:atomic_var(), _Arg :: integer()) -> integer().
atomic_var_fetch_sub(_Var, _Arg) ->
    erlang:nif_error(nif_library_not_loaded).

-spec atomic_var_fetch_sub(_Var :: vegrandis_var:atomic_var(), _Arg :: integer(), _Memory_Order :: vegrandis_var:memory_order()) -> integer().
atomic_var_fetch_sub(_Var, _Arg, _Memory_Order) ->
    erlang:nif_error(nif_library_not_loaded).

-spec atomic_var_fetch_and(_Var :: vegrandis_var:atomic_var(), _Arg :: integer()) -> integer().
atomic_var_fetch_and(_Var, _Arg) ->
    erlang:nif_error(nif_library_not_loaded).

-spec atomic_var_fetch_and(_Var :: vegrandis_var:atomic_var(), _Arg :: integer(), _Memory_Order :: vegrandis_var:memory_order()) -> integer().
atomic_var_fetch_and(_Var, _Arg, _Memory_Order) ->
    erlang:nif_error(nif_library_not_loaded).

-spec atomic_var_fetch_or(_Var :: vegrandis_var:atomic_var(), _Arg :: integer()) -> integer().
atomic_var_fetch_or(_Var, _Arg) ->
    erlang:nif_error(nif_library_not_loaded).

-spec atomic_var_fetch_or(_Var :: vegrandis_var:atomic_var(), _Arg :: integer(), _Memory_Order :: vegrandis_var:memory_order()) -> integer().
atomic_var_fetch_or(_Var, _Arg, _Memory_Order) ->
    erlang:nif_error(nif_library_not_loaded).

-spec atomic_var_fetch_xor(_Var :: vegrandis_var:atomic_var(), _Arg :: integer()) -> integer().
atomic_var_fetch_xor(_Var, _Arg) ->
    erlang:nif_error(nif_library_not_loaded).

-spec atomic_var_fetch_xor(_Var :: vegrandis_var:atomic_var(), _Arg :: integer(), _Memory_Order :: vegrandis_var:memory_order()) -> integer().
atomic_var_fetch_xor(_Var, _Arg, _Memory_Order) ->
    erlang:nif_error(nif_library_not_loaded).

-spec atomic_var_add_fetch(_Var :: vegrandis_var:atomic_var(), _Arg :: integer()) -> integer().
atomic_var_add_fetch(_Var, _Arg) ->
    erlang:nif_error(nif_library_not_loaded).

-spec atomic_var_sub_fetch(_Var :: vegrandis_var:atomic_var(), _Arg :: integer()) -> integer().
atomic_var_sub_fetch(_Var, _Arg) ->
    erlang:nif_error(nif_library_not_loaded).

-spec atomic_var_and_fetch(_Var :: vegrandis_var:atomic_var(), _Arg :: integer()) -> integer().
atomic_var_and_fetch(_Var, _Arg) ->
    erlang:nif_error(nif_library_not_loaded).

-spec atomic_var_or_fetch(_Var :: vegrandis_var:atomic_var(), _Arg :: integer()) -> integer().
atomic_var_or_fetch(_Var, _Arg) ->
    erlang:nif_error(nif_library_not_loaded).

-spec atomic_var_xor_fetch(_Var :: vegrandis_var:atomic_var(), _Arg :: integer()) -> integer().
